...
# Определения:
# Гипотезы:
# H0 - все средние равны (исслед. факторы не оказ. никакого влияния и полученные различия случайны)
# H1 - не все средние равны
# Анализ основан на сравнении межгрупповой и внутригрупповой дисперсий.
#
# k - число исследуемых групп
# ni - численность в каждой группе
# SSB - Межгрупповая сумма квадратов отклонений (Sum Square Between Groups)
# SSW - Внутригрупповая сумма квадратов отклонений (Sum Square Within Groups)
# dfB - Межгрупповая (факторная) дисперсия (Mean Square Between Groups)
# dfW - Внутригрупповая (остаточная) дисперсия (Mean Square Within Groups)
# SSB/SSW - F статистика. H0 - верна если F близка к 1, в противном случае значительно выше 1
